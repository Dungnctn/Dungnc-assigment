...
const AdminCate = {
              ...
              <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div class="lg:flex lg:items-center lg:justify-between">
                  ...
                  <div class="mt-5 flex lg:mt-0 lg:ml-4">
                    ...
                    <span class="sm:ml-3">
                      <a href="/#/admin/category/add"><button type="button" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                      ...
                      <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200">
                          ...
                          <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                              <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-300 text-white-800">
                                ${post.name}
                              </span>
                            </td>
    ...
    afterRender() {
        // lấy tất cả button có class là .btn
        const btns = document.querySelectorAll(".btn");
        // console.log(btns)
        // mỗi 1 element button sẽ gán vào buttonElement
        btns.forEach((buttonElement) => {
          // lấy id button thông qua property(thuộc tính) data-id
          ...
          buttonElement.addEventListener("click", () => {
            ...
            if(confirm){
              remove(idButton)
                .then(() => reRender(AdminCate, "#app"))
                .then(() => toastr.success("Xóa danh mục thành công"));
