...
const Signin = {
        ...
        return /*html*/ `
            <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div class="max-w-md w-full space-y-8">
                    ...
                    <div class="bg-red-500 alert er hidden text-[#fff]"></div>
                </div>
            </div>
    ...
    afterRender() {
        ...
        formSignin.addEventListener('submit', async (e) => {
            e.preventDefault();
            const alertErrpr = "Tài khoản không chính xác! Vui lòng đăng nhập lại.";
            try {
                ...
                document.querySelector(".er").innerHTML = alertErrpr;
